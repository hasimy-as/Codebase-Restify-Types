...
var getAdmins = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, handler_2["default"].getAdmins()];
            case 1:
                result = _a.sent();
...
var getAdminById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                params = req.params;
                return [4 /*yield*/, schema_2["default"].getAdminById.validateAsync(params)];
            case 1:
                parameter = _a.sent();
                if (parameter.err) {
                    return [2 /*return*/, response_1.sendResponse(parameter, res)];
                }
                return [4 /*yield*/, handler_2["default"].getAdminById(parameter)];
            case 2:
                result = _a.sent();
                return [2 /*return*/, response_1.sendResponse(result, res)];
        }
...
var createAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                body = req.body;
                return [4 /*yield*/, schema_1["default"].createAdmin.validateAsync(body)];
            case 1:
                data = _a.sent();
                if (data.err) {
                    return [2 /*return*/, response_1.sendResponse(data, res)];
                }
                return [4 /*yield*/, handler_1["default"].createAdmin(data)];
            case 2:
                result = _a.sent();
                return [2 /*return*/, response_1.sendResponse(result, res)];
        }
...
var loginAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                body = req.body;
                return [4 /*yield*/, schema_1["default"].loginAdmin.validateAsync(body)];
            case 1:
                data = _a.sent();
                if (data.err) {
                    return [2 /*return*/, response_1.sendResponse(data, res)];
                }
                return [4 /*yield*/, handler_1["default"].loginAdmin(data)];
            case 2:
                result = _a.sent();
                return [2 /*return*/, response_1.sendResponse(result, res)];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, schema_1["default"].updateAdmin.validateAsync(body)];
            case 1:
                data = _a.sent();
                if (data.err) {
                    return [2 /*return*/, response_1.sendResponse(data, res)];
                }
                return [4 /*yield*/, handler_1["default"].updateAdmin(__assign(__assign({}, data), { opts: opts }))];
            case 2:
                result = _a.sent();
                return [2 /*return*/, response_1.sendResponse(result, res)];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, schema_1["default"].deleteAdmin.validateAsync(params)];
            case 1:
                parameter = _a.sent();
                if (parameter.err) {
                    return [2 /*return*/, response_1.sendResponse(parameter, res)];
                }
                return [4 /*yield*/, handler_1["default"].deleteAdmin(__assign(__assign({}, parameter), { opts: opts }))];
            case 2:
                result = _a.sent();
                return [2 /*return*/, response_1.sendResponse(result, res)];
        }
