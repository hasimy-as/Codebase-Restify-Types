...
var Admin = /** @class */ (function () {
    ...
    ;
    Admin.prototype.getAdmins = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ctx, _a, admin, adminErr;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (adminErr) {
                            logger_1["default"].error(ctx, 'Cannot get all admins.', adminErr);
                            return [2 /*return*/, wrapper_1["default"].error('error', 'Cannot get all admins!', http_code_1.CODE.INTERNAL_ERROR)];
                        }
    ...
    ;
    Admin.prototype.getAdminById = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var ctx, _a, admin, adminErr;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ctx = 'Admin-getAdminById';
